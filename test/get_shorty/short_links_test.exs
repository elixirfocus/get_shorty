defmodule GetShorty.ShortLinksTest do
  ...
  #              ShortLinks.update_short_link(short_link, @update_attrs)
  ...
  #              ShortLinks.update_short_link(short_link, @invalid_attrs)
